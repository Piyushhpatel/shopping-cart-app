        ...
        <div className="flex items-center justify-between gap-16 w-full mt-5">
          ...
          <div>
            {cart.some((item) => item.item.id === id) ? (
              <button
                className="text-gray-700 border-2 border-gray-700 rounded-full font-bold text-[12px] p-1 px-3 uppercase hover:bg-gray-700 hover:text-white transition-all ease-in duration-300 select-none"
